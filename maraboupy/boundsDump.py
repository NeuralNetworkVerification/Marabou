...
mbouNet.setLowerBound(2, -1.)
mbouNet.setUpperBound(2,  1.)
mbouNet.setLowerBound(3, -1.)
mbouNet.setUpperBound(3,  1.)
mbouNet.inputVars = [np.array(list(range(4)))]
mbouNet.addEquality([0, 1, 4], [-1, 1, 1], 0)
mbouNet.addEquality([1, 2, 5], [-1, 1, 1], 0)
mbouNet.addEquality([2, 3, 6], [-1, 1, 1], 0)
