...
void SparseGaussianEliminator::initializeFactorization( const double *A, LUFactors *luFactors )
{
...
void SparseGaussianEliminator::run( const double *A, LUFactors *luFactors )
{
