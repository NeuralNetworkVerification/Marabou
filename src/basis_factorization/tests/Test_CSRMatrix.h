...
public:
    ...
    void test_sanity()
    {
        ...
        */
        ...
        double M2[] = {
            1, 2, 3, 4, 5, 8, 5, 6, 1, 2, 3, 4, 5, 6, 7, 8, 9, 1, 2, 3,
        };
    ...
    void test_add_last_row()
    {
        ...
        double expected[] = {
            0, 0, 0, 0, 5, 8, 0, 0, 0, 0, 3, 0, 0, 6, 0, 0, 1, 2, 0, 0, 0, 2, -3, 0, 1, 0, 0, 4,
        };
    ...
    void test_add_last_column()
    {
        {
            double M1[] = {
                0, 0, 0, 2, 5, 8, 0, 0, 0, 0, 3, 0, 0, 6, 0, 0,
            };
            ...
            double expected[] = {
                0, 0, 0, 2, 1, 0, 1, 5, 8, 0, 0, 2, 2, 0, 0, 0, 3, 0, 0, -3, 0, 0, 6, 0, 0, 0, 0, 4,
            };
    ...
    void test_to_dense()
    {
        ...
        {
            double M1[] = {
                0, 0, 0, 0, 0, 0, 0, 0, 5, 8, 0, 0, 1, 2, 3, 4, 0, 6, 0, 0,
            };
    ...
    void test_merge_columns()
    {
        {
            double M1[] = {
                0, 0, 0, 0, 5, 8, 0, 0, 0, 2, 3, 0, 0, 0, 4, 0,
            };
            ...
            double expected[] = {
                0, 0, 0, 0, 5, 8, 0, 0, 0, 5, 0, 0, 0, 4, 0, 0,
            };
        ...
        {
            double M1[] = {
                0, 0, -1, 1, 5, 8, 0, 1, 0, 2, 3, 0, 0, 0, 4, 1,
            };
            ...
            double expected[] = {
                0, 0, 0, 0, 5, 8, 1, 0, 0, 2, 3, 0, 0, 0, 5, 0,
            };
            ...
            double expected2[] = {
                0, 0, 0, 0, 5, 8, 1, 0, 0, 2, 3, 0, 0, 0, 5, 0, 1, 2, 3, 5,
            };
        ...
        {
            double M1[] = {
                0, 0, 0, 0, 5, 8, 0, 0, 0, 2, 3, 1, 0, 0, 4, 0,
            };
            ...
            double expected[] = {
                0, 0, 0, 0, 5, 8, 0, 0, 1, 2, 3, 0, 0, 0, 4, 0,
            };
...

        {
            ...
            double expected[] = {
                0, 0, 0, 0, 13, 0, 0, 0, 2, 0, 3, 1, 0, 0, 4, 0,
            };
    ...
    void test_deletions()
    {
        ...
        double expected[] = {
            0, 0, 0, 0, 0, 8, 0, 0, 0, 0, 3, 0, 0, 0, 0, 0,
        };
    ...
    void test_changes()
    {
        ...
        double expected[] = {
            0, 0, 2, 0, 5, 8, 0, 0, 0, 0, 4, 0, 0, 6, 0, 3,
        };

        double expected2[] = {
            0, 0, 5, 0, 5, 8, 0, 0, 1.5, 0, 4, 0, 0, 6, 0, 3,
        };
    ...
    void test_changes_and_deletions()
    {
        ...
        double expected[] = {
            0, 0, 2, 0, 5, 0, 0, 0, 0, 0, 4, 0, 0, 0, 0, 3,
        };

        double expected2[] = {
            0, 0, 2, 0, 5, 4, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0,
        };
    ...
    {
        double M1[] = {
            0, 0, 0, 0, 1, 5, 8, 0, 0, 2, 0, 2, 3, 0, 3, 0, 0, 4, 0, 4,
        };
    ...
    void test_transpose()
    {
        ...
        double expected[] = {
            0, 5, 0, 0, 0, 8, 2, 0, 0, 0, 3, 4, 0, 0, 0, 0, 1, 2, 3, 4,
        };
