...
public:
    ...
    void setUp()
    {
        ...
        */
        ...
        double F[16] = {
            1, 0, 2, 0, -2, 1, 4, 5, 0, 0, 1, 0, 0, 0, 3, 1,
        };
        ...
        */
        ...
        double V[16] = {
            0, 1, 5, 2, 0, 7, 0, 0, 1, -3, -2, 3, 0, 2, -2, 0,
        };
    ...
    void test_invert_basis()
    {
        ...
        */
        double expectedInverse[] = {
            5.0 / 2, 2,       129.0 / 4, -59.0 / 4,  2.0 / 7,   1.0 / 7,  1,         -5.0 / 7,
            2.0 / 7, 1.0 / 7, 5.0 / 2,   -17.0 / 14, -5.0 / 14, -3.0 / 7, -31.0 / 4, 95.0 / 28,
        };
