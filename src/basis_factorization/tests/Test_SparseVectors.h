...
class MockForSparseVectors
{
public:
};

class SparseVectorsTestSuite : public CxxTest::TestSuite
{
public:
    MockForSparseVectors *mock;

    void setUp()
    {
        TS_ASSERT( mock = new MockForSparseVectors );
    }
