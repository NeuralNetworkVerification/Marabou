...
const bool GlobalConfiguration::USE_SYMBOLIC_BOUND_TIGHTENING = true; // todo make true
...
const bool GlobalConfiguration::PREPROCESSOR_MERGE_CONSECUTIVE_WEIGHTED_SUMS = true; // todo make true
