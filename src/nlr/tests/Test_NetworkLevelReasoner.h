...
public:
    ...
    void populateNetworkBackwardReluAndBilinear( NLR::NetworkLevelReasoner &nlr, MockTableau &tableau )
    {
        /*
                a    a'
          x                e
   ...
   void test_evaluate_leaky_relu()
    ...
    void test_interval_arithmetic_bound_propagation_softmax_and_max_constraints()
    {
        ...
        List<Tightening> expectedBounds2( {
            ...
            Tightening( 8, -0.9811, Tightening::LB ),  Tightening( 8, 1.9468, Tightening::UB ),
            Tightening( 9, 0.0654, Tightening::LB ),   Tightening( 9, 2.9933, Tightening::UB ),
            
            Tightening( 10, 0.0654, Tightening::LB ),  Tightening( 10, 2.9933, Tightening::UB ),
            
            Tightening( 11, -2.9933, Tightening::LB ), Tightening( 11, -0.0654, Tightening::UB )
        } );
    ...
    void test_sbt_relu_residual2()
    {
        ...
        /*
          ...
          x5.ub =  3 ( -15/14 x0 + 20/14 ) + 1 ( x0 ) + 1 = -31/14 x0 + 74/14 : [43/14, 105/14 = 7.5]
          x5 range: [0, 7.5]
    ...
    void test_sbt_leaky_relu()
    {
        ...
        /*
          ...
          x10.ub =  1 ( -0.24 x0 + 0.96 x1 + 1.6 ) + 1 ( 0.8x0 + 2 ) + 1 = 0.56x0 + 0.96x1 + 4.6   : [3.08, 6.12]
          x10 range: [-3.8, 6.12]
    ...
    void test_sbt_softmax3()
    {
        ...
        */
        ...
        List<Tightening> expectedBounds({  Tightening( 3, 2, Tightening::LB ),
                                           ...
                                           Tightening( 8, 0.8668, Tightening::LB ),
                                           Tightening( 8, 0.8668, Tightening::UB ),
                                           Tightening( 9, 0.9820, Tightening::LB ),
                                           Tightening( 9, 0.9820, Tightening::UB ),
                                           Tightening( 10, 0.1173, Tightening::LB ),
                                           Tightening( 10, 0.1173, Tightening::UB ),
                                           Tightening( 11, 0.0179, Tightening::LB ),
                                           Tightening( 11, 0.0179, Tightening::UB ),
                                           Tightening( 12, 0.0159, Tightening::LB ),
                                           Tightening( 12, 0.0159, Tightening::UB ),
                                           Tightening( 13, 0.9470, Tightening::LB ),
                                           Tightening( 13, 0.9470, Tightening::UB ),
                                           Tightening( 14, -0.9470, Tightening::LB ),
                                           Tightening( 14, -0.9470, Tightening::UB ),
                                           Tightening( 15, 1.0253, Tightening::LB ),
                                           Tightening( 15, 1.0253, Tightening::UB ),
                                           Tightening( 16, -1.0253, Tightening::LB ),
                                           Tightening( 16, -1.0253, Tightening::UB )
    ...
    {
        Options::get()->setString( Options::SYMBOLIC_BOUND_TIGHTENING_TYPE, "sbt" );
        Options::get()->setString( Options::MILP_SOLVER_BOUND_TIGHTENING_TYPE, "backward-converge" );
    ...
    void test_backwards_round()
    {
        ...
        List<Tightening> expectedBounds2(
            { Tightening( 11, -4, Tightening::LB ),      Tightening( 11, 6, Tightening::UB ),
            } );
        ...
        List<Tightening> expectedBounds4(
            { Tightening( 7, -10, Tightening::LB ),          Tightening( 7, 5, Tightening::UB ),
              
              Tightening( 11, -14, Tightening::LB ),         Tightening( 11, 11, Tightening::UB ),
            } );
    ...
    void test_backwards_softmax_and_max()
    {
        ...
        List<Tightening> expectedBounds(
            { Tightening( 2, 1, Tightening::LB ),        Tightening( 2, 2, Tightening::UB ),
              ...
              Tightening( 8, -0.1519, Tightening::LB ),  Tightening( 8, 1.4775, Tightening::UB ),
              Tightening( 9, 0.6614, Tightening::LB ),   Tightening( 9, 2.3899, Tightening::UB ),

              Tightening( 10, 0.6614, Tightening::LB ),  Tightening( 10, 2.3899, Tightening::UB ),
              
              Tightening( 11, -2.3899, Tightening::LB ), Tightening( 11, -0.6614, Tightening::UB ),
            } );
        ...
        List<Tightening> expectedBounds3(
            { Tightening( 2, -2, Tightening::LB ),       Tightening( 2, 2, Tightening::UB ),
              ...
              Tightening( 8, -0.9811, Tightening::LB ),  Tightening( 8, 1.9468, Tightening::UB ),
              Tightening( 9, 0.0674, Tightening::LB ),   Tightening( 9, 2.9934, Tightening::UB ),

              Tightening( 10, 0.0674, Tightening::LB ),  Tightening( 10, 2.9934, Tightening::UB ),
              
              Tightening( 11, -2.9934, Tightening::LB ), Tightening( 11, -0.0674, Tightening::UB ),
            } );
    ...
    void test_backwards_softmax_and_max2()
    {
        ...
        List<Tightening> expectedBounds(
            { Tightening( 3, -2, Tightening::LB ),            Tightening( 3, 2, Tightening::UB ),
              ...
              Tightening( 11, 1.0013, Tightening::LB ),       Tightening( 11, 4.9635, Tightening::UB ),
              Tightening( 12, -0.9861, Tightening::LB ),      Tightening( 12, 2.9806, Tightening::UB ),
              Tightening( 13, -2.9902, Tightening::LB ),      Tightening( 13, 0.9678, Tightening::UB ),
              
              Tightening( 14, 0.1086, Tightening::LB ),       Tightening( 14, 0.9971, Tightening::UB ),
              Tightening( 15, 0.0026, Tightening::LB ),       Tightening( 15, 0.8766, Tightening::UB ),
              Tightening( 16, 0.0003, Tightening::LB ),       Tightening( 16, 0.4595, Tightening::UB ),
              
              Tightening( 17, 0.1086, Tightening::LB ),       Tightening( 17, 0.9971, Tightening::UB ),
            } );
        ...
        List<Tightening> expectedBounds3(
            { Tightening( 3, -2, Tightening::LB ),       Tightening( 3, 5, Tightening::UB ),
              ...
              Tightening( 11, 1.0003, Tightening::LB ),  Tightening( 11, 4.9989, Tightening::UB ),
              Tightening( 12, -0.9999, Tightening::LB ), Tightening( 12, 2.9979, Tightening::UB ),
              Tightening( 13, -2.9989, Tightening::LB ), Tightening( 13, 0.9980, Tightening::UB ),
              
              Tightening( 14, 0.1067, Tightening::LB ),  Tightening( 14, 0.9972, Tightening::UB ),
              Tightening( 15, 0.0024, Tightening::LB ),  Tightening( 15, 0.8786, Tightening::UB ),
              Tightening( 16, 0.0003, Tightening::LB ),  Tightening( 16, 0.4677, Tightening::UB ),
              
              Tightening( 17, 0.1067, Tightening::LB ),  Tightening( 17, 0.9972, Tightening::UB ),
            } );
    ...
    {
        Options::get()->setString( Options::SYMBOLIC_BOUND_TIGHTENING_TYPE, "sbt" );
        Options::get()->setString( Options::MILP_SOLVER_BOUND_TIGHTENING_TYPE, "backward-preimage-approx" );
        ...
        List<PolygonalTightening> polygonal_bounds;
        
        TS_ASSERT_THROWS_NOTHING( nlr.getConstraintPolygonalTightenings( polygonal_bounds ) );
        for ( auto &bound : polygonal_bounds )
        {
            bound.dump();
        }
        /*TS_ASSERT( boundsEqual( bounds, expectedBounds2 ) );
    ...
    bool boundsEqual( const List<Tightening> &bounds, const List<Tightening> &expectedBounds )
    {
        ...
        for ( const auto &bound : bounds )
        {
            ...
            {
                currentFound |= ( bound._type == expectedBound._type && bound._variable == expectedBound._variable &&
