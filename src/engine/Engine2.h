...
public:
    ...
    */
    ...
    /*
      Get the exit code
    */
    Engine2::ExitCode getExitCode() const;
...
private:
    ...
    */
    SmtStackManager _smtStackManager;

    /*
      The smt logic/split provider based on constraint violations
    */
   std::shared_ptr<SmtCoreSplitProvider> _smtCoreSplitProvider;
