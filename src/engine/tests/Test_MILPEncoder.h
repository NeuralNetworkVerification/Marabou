...
{
public:
    MockForMILPEncoder *mock;

	void setUp()
    {
        TS_ASSERT( mock = new MockForMILPEncoder );
    }
    ...
    void test_eoncode_max_constraint()
    {
        ...
        InputQuery *inputQuery1 = new InputQuery();
        ...
        InputQuery *inputQuery5 = new InputQuery();
