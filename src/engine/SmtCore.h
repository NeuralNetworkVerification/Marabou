 ...
 **
 ** The SmtCore class implements a context-dependent SmtCore class.
 ** The SmtCore distinguishes between: **decisions** and **implications**.
 **
 ...
 ** - SmtCore::_trail is the current search state in a chronological order
 ...
 **
 ** When a search state is found to be infeasible, SmtCore backtracks to the
