...
public:
    ...
    */
    ...
    virtual void stackBoundExplanation( const unsigned index, const unsigned depth, const bool isUpper ) const = 0;
	virtual void popAllboundsxplanations( const unsigned depth ) const = 0;
