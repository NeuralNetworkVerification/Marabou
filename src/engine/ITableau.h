...
public:
    ...
    */
    ...
    virtual void getSparseAColumn( unsigned variable, SparseUnsortedVector *result ) const = 0;
    virtual void getSparseARow( unsigned row, SparseUnsortedVector *result ) const = 0;
    virtual const SparseUnsortedVector *getSparseAColumn( unsigned variable ) const = 0;
