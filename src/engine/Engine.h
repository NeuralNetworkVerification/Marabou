...
public:
    ...
    */
    bool solve( List<Map<unsigned, bool>> gammaUnsat, Map< unsigned, Pair<unsigned, unsigned> > gammaAbs, Map<unsigned, bool> is_pos, Map<unsigned, bool> is_inc, Map<unsigned, unsigned> post_var_indices, unsigned timeoutInSeconds = 0 );
