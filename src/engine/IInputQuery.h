...
#ifndef __IInputQuery_h__
#define __IInputQuery_h__
...
public:
    ...
    virtual unsigned getNumberOfEquations() = 0;
    ...
    virtual InputQuery generateQuery() const = 0;
