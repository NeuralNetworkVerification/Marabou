...
void AppendProtoDebugString(
  ...
  o->AppendNumericIfNotZero("deprecation_version", msg.deprecation_version());
}
...
void AppendProtoDebugString(
  ...
  if (msg.visibility() != 0) {
    o->AppendEnumName("visibility", ::tensorflow::EnumName_ApiDef_Visibility(msg.visibility()));
  }
