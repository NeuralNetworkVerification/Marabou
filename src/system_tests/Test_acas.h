...
public:
    ...
    /*     AcasParser acasParser( "../../../resources/nnet/acasxu/ACASXU_experimental_v2a_2_2.nnet" ); */
    ...
    {
        InputQuery inputQuery;
        AcasParser acasParser( "../../../resources/nnet/acasxu/ACASXU_experimental_v2a_1_1.nnet" );
        acasParser.generateQuery( inputQuery );
        ...
        {
            unsigned variable = acasParser.getInputVariable( i );
            inputQuery.setLowerBound( variable, -0.01 );
